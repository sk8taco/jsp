    ...
    <td align="center" valign="middle" bgcolor="#FFFFCC"> 
      <table border="1" cellspacing="0" cellpadding="2"  align="center">
        <form name="regForm" method="post" action="RegisterProc.jsp">
          ...
          <tr> 
            <td width="16%">아이디</td>
            <td width="57%"> <input type="text" id="mem_id" name="mem_id" size="15">
		      <input type="button" value="ID중복확인" 
       onClick="idCheck(this.form.mem_id.value)"></td> <!-- 이 폼안의 mem_id 값을 체크하자 -->
            <td id="doucheck" width="27%">아이디를 적어 주세요.</td>
          </tr>
          <tr> 
            <td>패스워드</td>
